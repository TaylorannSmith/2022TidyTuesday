...
plot2 =df1 %>%
  ...
  scale_color_manual("Projected",values=c("#304D63","#B2E7E8","#8FB9AA","#F2D096")) +
  scale_fill_manual("Projected",values=c("#304D63","#B2E7E8","#8FB9AA","#F2D096")) +
...
plot2
ggsave(here("2022TidyTuesday","Week6", "plot.png"))
